...
.fc-spin-wheel-snippet-19212-root {
	display: flex;
...
`;
    ...
    p(() => {
      const fetchScratchCard = async () => {
        try {
          setLoading(true);
          const client_id = mainScript.getAttribute("data-client-id");
          const response = await fetchApi$1("/get-featured-spin-wheels", "post", {
            client_id
          });
          setScratchCardData(response == null ? void 0 : response.data);
        } catch (error) {
  ...
  async function renderSpinWheelSnippet() {
    ...
    try {
      ...
      let shadowRoot = document.createElement("div");
      shadowRoot.className = "fc-spin-wheel-snippet-19212-root";
      shadow.appendChild(shadowRoot);
      let themeDetailsData;
      if ((_a = window == null ? void 0 : window.fc_loyalty_vars) == null ? void 0 : _a.theme_details) {
        themeDetailsData = (_b = window == null ? void 0 : window.fc_loyalty_vars) == null ? void 0 : _b.theme_details;
  ...
  window.fc_loyalty_render_wallet_box = renderSpinWheelSnippet;
  renderSpinWheelSnippet();
})();
